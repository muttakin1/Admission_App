    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          label: 'Number Of Students in Slass',
          fill:false,
          data: numberOfSlass,//[numberOfStd[0], numberOfStd[1], numberOfStd[2], numberOfStd[3], numberOfStd[4], numberOfStd[5], numberOfStd[6], numberOfStd[7],],
          ...
          label: 'Number Of Students in SLS',
          fill:false,
          data: numberOfSls,//[numberOfSob[0], numberOfSob[1], numberOfSob[2], numberOfSob[3], numberOfSob[4], numberOfSob[5], numberOfSob[6], numberOfSob[7],],
