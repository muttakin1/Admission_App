...
// for(i = 0; i <36; i+=2) { 
//       if(imgArray[i]!=emptyImg1 && imgArray[i]!=emptyImg2){
//         console.log("full");
//         // Graph Page Start:    
//         doc.addPage('a4','p');
...
//          if(imgArray[i+1]!=emptyImg1 && imgArray[i+1]!=emptyImg2){
//           // console.log("full");
